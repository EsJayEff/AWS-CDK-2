...
export class Step14CiCdPipelineStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const stackName = "BackendDeploymentStack";
    ...
    const pipline = new CodePipeline.Pipeline(this, 'CDKPipeline', {
      ...
      restartExecutionOnUpdate: true,  //Indicates whether to return the AWS CodePipeline pipeline after you update it.
    });
    ...
    pipline.addStage({
      ...
      actions: [
        new CodePipelineAction.GitHubSourceAction({
          actionName: 'Checkout',
          owner: 'EsJayEff',
          repo: "cdkPipelineBackend",
          oauthToken: SecretValue.unsafePlainText("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"), ///create token on github and save it on aws secret manager
